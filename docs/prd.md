...
- **Armazenamento de imagens e vídeos no IndexedDB**
...
- **Envio de imagens**
- **Envio de vídeos**
- **Seleção de imagens via input file ou captura de câmera**
- **Seleção de vídeos via input file ou captura de câmera**
- **Pré-visualização de imagens antes de enviar**
- **Pré-visualização de vídeos antes de enviar**
- **Compressão de imagens para otimizar transferência P2P**
- **Compressão de vídeos para otimizar transferência P2P**
- **Envio de imagens e vídeos via DataChannel em chunks**
- **Exibição de imagens no histórico de mensagens**
- **Exibição de vídeos no histórico de mensagens com player integrado**
- **Controles de reprodução de vídeo (play, pause, barra de progresso, volume)**
- **Armazenamento de imagens e vídeos no IndexedDB com referência na conversa**
...
- **Histórico de imagens salvo localmente**
- **Histórico de vídeos salvo localmente**
...
### 3.8 Envio de Imagens\n- **Botão de enviar imagem na interface de chat**
- **Seleção de imagem via input file (galeria)**
- **Captura de imagem via câmera (getUserMedia)**
- **Pré-visualização da imagem antes de enviar**\n- **Compressão de imagem para otimizar transferência P2P**\n- **Conversão de imagem para formato otimizado (JPEG/WebP)**
- **Envio da imagem via DataChannel em chunks**
- **Exibição de imagem no histórico de mensagens**
- **Opção de visualizar imagem em tamanho completo**
- **Armazenamento de imagens no IndexedDB com referência na conversa**
- **Indicador de progresso durante envio de imagem**

### 3.9 Envio de Vídeos
- **Botão de enviar vídeo na interface de chat**\n- **Seleção de vídeo via input file (galeria)**
- **Captura de vídeo via câmera (getUserMedia + MediaRecorder)**
- **Pré-visualização do vídeo antes de enviar**\n- **Compressão de vídeo para otimizar transferência P2P**
- **Conversão de vídeo para formato otimizado (MP4/WebM)**
- **Envio do vídeo via DataChannel em chunks**
- **Exibição de vídeo no histórico de mensagens com thumbnail**
- **Player de vídeo integrado para reprodução**
- **Controles de reprodução de vídeo: play/pause, barra de progresso, volume, tela cheia**
- **Armazenamento de vídeos no IndexedDB com referência na conversa**
- **Indicador de progresso durante envio de vídeo**
- **Limitação de tamanho de vídeo para garantir transferência viável**
...
- **Botão de enviar imagem no campo de mensagem**
- **Botão de enviar vídeo no campo de mensagem**
- **Interface de gravação de áudio com controles**
- **Interface de seleção/captura de imagem**
- **Interface de seleção/captura de vídeo**\n- **Pré-visualização de imagem antes de enviar**
- **Pré-visualização de vídeo antes de enviar**\n- **Player de áudio integrado nas mensagens**
- **Visualizador de imagens integrado nas mensagens**
- **Player de vídeo integrado nas mensagens**
...
- **Notificação sonora ao receber imagem**
- **Notificação sonora ao receber vídeo**
- **Notificação sonora ao receber chamada de voz**
...
- **Feedback visual durante envio de imagem (barra de progresso)**
- **Feedback visual durante envio de vídeo (barra de progresso)**
...
- **Envio de imagens requer ambos os usuários online e conectados**
- **Envio de vídeos requer ambos os usuários online e conectados**
...
- **Tamanho de imagens limitado pela capacidade do DataChannel e IndexedDB**
- **Tamanho de vídeos limitado pela capacidade do DataChannel e IndexedDB**
- **Transferência de arquivos grandes (imagens/vídeos) pode ser lenta dependendo da conexão**
...
- **Permissões para acesso à câmera (para captura de imagens e vídeos)**
- **Permissões para acesso à galeria (para seleção de imagens e vídeos)**
...
- **Suporte a envio e recebimento de imagens**
- **Suporte a envio e recebimento de vídeos**
- **Armazenamento local de mídias (áudio, imagem, vídeo) no IndexedDB**